...
def check_stability(positions, atom_type, dataset_info, debug=False, atom_decoder=None):
...
def analyze_stability_for_molecules(molecule_list, dataset_info, atom_decoder):
    ...
    for mol in processed_list:
        pos, atom_type = mol
        validity_results = check_stability(pos, atom_type, dataset_info, atom_decoder=atom_decoder)
